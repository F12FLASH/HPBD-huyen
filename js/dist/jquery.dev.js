...
(function (e, t) {
...
})(typeof window != "undefined" ? window : void 0, function (e, t) {
  function y(e) {
    var t = e.length,
        n = p.type(e);
  ...
  function z(e, t, r, i) {
    ...
    if (_typeof(t) == "object" || typeof t == "function") i ? f[l] = p.extend(f[l], t) : f[l].data = p.extend(f[l].data, t);
  ...
  function Et(e, t) {
    var n,
        r,
        i = 0,
        s = _typeof(e.getElementsByTagName) !== j ? e.getElementsByTagName(t || "*") : _typeof(e.querySelectorAll) !== j ? e.querySelectorAll(t || "*") : undefined;
    if (!s) for (s = [], n = e.childNodes || e; (r = n[i]) != null; i++) {
  ...
  function Kn(e, t, n, r) {
    ...
    if (p.isArray(t)) p.each(t, function (t, i) {
      n || Xn.test(e) ? r(e, i) : Kn(e + "[" + (_typeof(i) == "object" ? t : "") + "]", i, n, r);
    });else if (!n && p.type(t) === "object") for (i in t) {
      Kn(e + "[" + i + "]", t[i], n, r);
    } else r(e, t);
  }
  ...
  p.fn = p.prototype = {
    ...
    var e,
        ...
        a = arguments.length,
        f = !1;
    typeof o == "boolean" && (f = o, o = arguments[u] || {}, u++), _typeof(o) != "object" && !p.isFunction(o) && (o = {}), u === a && (o = this, u--);
    ...
    type: function type(e) {
      return e == null ? e + "" : _typeof(e) == "object" || typeof e == "function" ? u[a.call(e)] || "object" : _typeof(e);
    },
    ...
    proxy: function proxy(e, t) {
      var n, i, s;
      return typeof t == "string" && (s = e[t], t = e, e = s), p.isFunction(e) ? (n = r.call(arguments, 2), i = function i() {
  ...
  var b = function (e) {
    ...
    function ht(e) {
      return e && _typeof(e.getElementsByTagName) !== C && e;
    }
    ...
    function wt(e) {
      ...
      for (; f < s; f++) {
        if (n = r.relative[e[f].type]) h = [mt(gt(h), n)];else {
    ...
    function Et(e, t) {
      var n = t.length > 0,
        ...
        if (n && m !== v) {
          ...
          _.apply(f, y), l && !_s && y.length > 0 && v + t.length > 1 && rt.uniqueSort(f);
        }
    ...
    var t,
      ...
      return e === t && (f = !0), 0;
        ...
        C = typeof undefined === "undefined" ? "undefined" : _typeof(undefined),
        k = 1 << 31,
        L = {}.hasOwnProperty,
        A = [],
        O = A.pop,
    ...
    n = rt.support = {}, s = rt.isXML = function (e) {
      ...
      c = i, h = i.documentElement, p = !s(i), o && o !== o.top && (o.addEventListener ? o.addEventListener("unload", function () {
        ...
        if (_typeof(t.getElementById) !== C && p) {
        ...
        var t = e.replace(et, tt);
        return function (e) {
          var n = _typeof(e.getAttributeNode) !== C && e.getAttributeNode("id");
          return n && n.value === t;
        };
      }), r.find.TAG = n.getElementsByTagName ? function (e, t) {
        if (_typeof(t.getElementsByTagName) !== C) return t.getElementsByTagName(e);
      } : function (e, t) {
        var n,
            r = [],
            i = 0,
        ...
        if (_typeof(t.getElementsByClassName) !== C && p) return t.getElementsByClassName(e);
      }, v = [], d = [];
      ...
      filter: {
        ...
        CLASS: function CLASS(e) {
          ...
          return t || (t = new RegExp("(^|" + B + ")" + e + "(" + B + "|$)")) && S(e, function (e) {
            return t.test(typeof e.className == "string" && e.className || _typeof(e.getAttribute) !== C && e.getAttribute("class") || "");
          });
        },
        ...
        CHILD: function CHILD(e, t, n, r, i) {
          ...
          return r === 1 && i === 0 ? function (e) {
            ...
            if (m) {
              ...
              } else if (b && (f = (t[y] || (t[y] = {}))[e]) && f[0] === w) h = f[1];else while (c = ++p && c && c[v] || (h = p = 0) || d.pop()) {
    ...
    if (typeof e == "string") {
      ...
      if (n && (n[1] || !t)) {
        if (n[1]) {
          ...
          if (E.test(n[1]) && p.isPlainObject(t)) for (n in t) {
  ...
  var j = typeof undefined === "undefined" ? "undefined" : _typeof(undefined),
      F;
  ...
  var X = /[+-]?(?:\d*\.|)\d+(?:[eE][+-]?\d+|)/.source,
    ...
    if (p.type(n) === "object") {
      ...
      i = !0, p.isFunction(r) || (o = !0), f && (o ? (t.call(e, r), t = null) : (f = t, t = function t(e, _t2, n) {
        return f.call(p(e), n);
      }));
      if (t) for (; u < a; u++) {
  ...
  p.event = {
    ...
    add: function add(e, t, n, r, i) {
      ...
      n.handler && (a = n, n = a.handler, i = a.selector), n.guid || (n.guid = p.guid++), (o = g.events) || (o = g.events = {}), (l = g.handle) || (l = g.handle = function (e) {
        return _typeof(p) === j || !!e && p.event.triggered === e.type ? undefined : p.event.dispatch.apply(l.elem, arguments);
    ...
    trigger: function trigger(t, n, r, i) {
      ...
      v.indexOf(".") >= 0 && (m = v.split("."), v = m.shift(), m.sort()), o = v.indexOf(":") < 0 && "on" + v, t = t[p.expando] ? t : new p.Event(v, _typeof(t) == "object" && t), t.isTrigger = i ? 2 : 3, t.namespace = m.join("."), t.namespace_re = t.namespace ? new RegExp("(^|\\.)" + m.join("\\.(?:.*\\.|)") + "(\\.|$)") : null, t.result = undefined, t.target || (t.target = r), n = n == null ? [t] : p.makeArray(n, [t]), l = p.event.special[v] || {};
    ...
    handlers: function handlers(e, t) {
      var n,
          ...
          u = t.delegateCount,
          a = e.target;
      if (u && a.nodeType && (!e.button || e.type !== "click")) for (; a != this; a = a.parentNode || this) {
    ...
    var r = "on" + t;
    e.detachEvent && (_typeof(e[r]) === j && (e[r] = null), e.detachEvent(r, n));
      ...
      for (; (r = e[u]) != null; u++) {
        if (t || p.acceptData(r)) {
          ...
          if (o) {
            ...
            f[s] && (delete f[s], l ? delete r[a] : _typeof(r.removeAttribute) !== j ? r.removeAttribute(a) : r[a] = null, n.push(s));
          }
        }
      }
    }
  ...
  (function () {
    ...
    n.innerHTML = "  <link/><table></table><a href='/a'>a</a><input type='checkbox'/>", e = n.getElementsByTagName("a")[0], e.style.cssText = "float:left;opacity:.5", c.opacity = /^0.5/.test(e.style.opacity), c.cssFloat = !!e.style.cssFloat, n.style.backgroundClip = "content-box", n.cloneNode(!0).style.backgroundClip = "", c.clearCloneStyle = n.style.backgroundClip === "content-box", e = n = null, c.shrinkWrapBlocks = function () {
      ...
      if (t == null) {
        ...
        if (!e) return;
        s = "border:0;width:0;height:0;position:absolute;top:0;left:-9999px", n = N.createElement("div"), i = N.createElement("div"), e.appendChild(n).appendChild(i), t = !1, _typeof(i.style.zoom) !== j && (i.style.cssText = r + ";width:1px;padding:1px;zoom:1", i.innerHTML = "<div></div>", i.firstChild.style.width = "5px", t = i.offsetWidth !== 3), e.removeChild(n), e = n = i = null;
      }
  ...
  e.getComputedStyle ? (Ht = function Ht(e) {
  ...
  }) : N.documentElement.currentStyle && (Ht = function Ht(e) {
  ...
  p.extend({
    ...
    style: function style(e, t, n, r) {
      ...
      s = _typeof(n), s === "string" && (i = zt.exec(n)) && (n = (i[1] + 1) * i[2] + parseFloat(p.css(e, t)), s = "number");
  ...
  p.Animation = p.extend(hn, {
    ...
    var r = e && _typeof(e) == "object" ? p.extend({}, e) : {
  ...
  p.fn.extend({
    ...
    attr: function attr(e, t, n) {
      ...
      if (_typeof(e.getAttribute) === j) return p.prop(e, t, n);
  ...
  Cn = Pn.exec(kn.toLowerCase()) || [], p.extend({
    ...
    ajax: function ajax(e, t) {
      ...
      _typeof(e) == "object" && (t = e, e = undefined), t = t || {};
      var n,
          r,
          i,
          s,
    ...
    if (!e.crossDomain || c.cors) {
      ...
      return {
        send: function send(n, r) {
          ...
          if (e.xhrFields) for (i in e.xhrFields) {
            s[i] = e.xhrFields[i];
          }
          ...
          s.send(e.hasContent && e.data || null), _t3 = function t(n, i) {
            ...
            if (_t3 && (i || s.readyState === 4)) {
              delete Gn[o], _t3 = undefined, s.onreadystatechange = p.noop;
          ...
          }, e.async ? s.readyState === 4 ? setTimeout(_t3) : s.onreadystatechange = Gn[o] = _t3 : _t3();
        },
  ...
  p.fn.load = function (e, t, n) {
    ...
    var r,
        ...
        o = this,
        u = e.indexOf(" ");
    return u >= 0 && (r = e.slice(u, e.length), e = e.slice(0, u)), p.isFunction(t) ? (n = t, t = undefined) : t && _typeof(t) == "object" && (s = "POST"), o.length > 0 && p.ajax({
      url: e,
      type: s,
      dataType: "html",
      data: t
    ...
    offset: function offset(e) {
      ...
      var t,
        ...
        left: 0
          ...
          s = i && i.ownerDocument;
      if (!s) return;
      return t = s.documentElement, p.contains(t, i) ? (_typeof(i.getBoundingClientRect) !== j && (r = i.getBoundingClientRect()), n = sr(s), {
